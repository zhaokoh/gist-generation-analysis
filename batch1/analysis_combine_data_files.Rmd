...
summary_files = c(
  ...
  '../../data/batch_1/gist_batch_v1_1_5_mt_summary.csv'
)
details_files = c(
  ...
  '../../data/batch_1/gist_batch_v1_1_5_mt_raw-sc.csv'
)

all_summary_filename = '../../data/batch_1/gist_batch_v1_1_mt_summary_all.csv'
all_details_filename = '../../data/batch_1/gist_batch_v1_1_mt_raw_all.csv'
